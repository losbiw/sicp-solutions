...
;; test
(define first-coeff (make-dense-polynomial 'y '(1 1)))
(define second-coeff (make-sparse-polynomial 'y '((2 1) (0 1))))
(define third-coeff (make-dense-polynomial 'y '(1 -1)))
(define test-poly
  (make-dense-polynomial 'x (list first-coeff second-coeff third-coeff)))

; test
(coerce-polynomial test-poly 'y)

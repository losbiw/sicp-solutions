...
; Timing data roughly resembles the growth of sqrt(10)
; Bigger inputs give more accurate growth predictions
; Time to run is proportional to the number of operations required